...
class LMStudioClient : Client {
    ...
    override suspend fun sendMessage(
        ...
        return try {
            // Convert CoreMessage to LMStudioMessage
            ...
            requestInfo.append("\nRequest JSON:\n${jsonParser.encodeToString(LMStudioRequest.serializer(), request)}\n")
            ...
            val response: LMStudioResponse = jsonParser.decodeFromString(responseBody)
